package com.mahrisoft.delta.iptv.controller;
...
import com.mahrisoft.tools.Internet;
import com.mahrisoft.tools.DeltaDB;
/**
 * @author Ould_Hamdi
 */
public class Controller {
    String html="<html><head></head><body><h1 style='color:red'>%s</h1></body></html>";
